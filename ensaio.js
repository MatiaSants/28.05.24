...
class Pessoa {
    constructor (musicalidade, corpo, idade, peso, cor, coordenacao_motora, altura, ritmo, nome, ano_nascimento, mes_nascimento, dia_nascimento, 
        nome_pai, nome_mae, rg, cpf, endereco, numero_endereco, bairro, cidade, estado, cep, whatsapp, facebook, instagram, twiter_x, linkedin, email, 
        tiktok, youtube, snapchat, orkut, tinder, uber, app_99, profissao, nacionalidade, estado_civil, possui_deficiencia, cnh, passaporte, religiao, 
        partido_politico, idioma, figurino, ) 
    {
...
var pessoa = [];
pessoa[0] = new Pessoa("Calebe", 17, 59,"1,72", "preto", "eclética", "magro");
pessoa[1] = new Pessoa("Giovani", 16, 53,"1,63", "pardo", "rap", "magro");
pessoa[2] = new Pessoa("Miguel", 16, 60,"1,62", "parda", "gospel internacional", "midsize");
pessoa[3] = new Pessoa("Joao", 17, 60,"1,52", "parda", "eclética", "atlético");
pessoa[4] = new Pessoa("Guilherme", 17, 70,"1,68", "parda", "eclética", "midsize");
pessoa[5] = new Pessoa("Nemo", 17, 57,"1,65", "branca", "eclética", "atlético");
pessoa[6] = new Pessoa("Gabi", 17, 63,"1,65", "preta", "eclética", "atlético");
pessoa[7] = new Pessoa("Bernardo", 18, 65,"1,65", "branca", "eclética", "atlético");
pessoa[8] = new Pessoa("Nicole", 16, 55,"1,63", "branca", "gospel", "magro");


class Musica {
    constructor (ritmo, velocidade, compasso, artista, nome, ano, tempo, idioma, tipo, genero, autor, compositor, musica, letra, instrumentos, volume, 
        vocalista, baterista, guitarrista, baixista, sonoplasta) {
        this.ritmo = ritmo;
...
class Ritmo {
    constructor (movimento, tempo, velocidade, som, compasso, coreografia, nome, quantidade_de_pessoas, musica, bpm, sincronia, harmonia, vestimentas, 
        genero_musical, maquiagens, equipamentos, local_de_ensaio, melodia, composicao, compositor, instrumentos) {
...
class LocalDoEnsaio {
    constructor (espaco, largura, altura, profundidade, energia, som, musica, microfone, 
        palco, cadeira, capacidade_de_pessoas, equipamentos_de_luz, internet, cabo_de_energia, apresentacoes, 
        stands, disponibilidade, seguranca, horario_de_funcionamento, acessibilidade, publico, artistas, janela, 
        porta, camarim, comida, sala_de_descanso, escadas, ) {
...
class Banheiro {
    constructor (genero, produtos, torneira, piz, vaso, piso, agua, energia, espelho, toalha_de_papel, suporte_de_sabonete, sabonete, suporte_de_bolsa, 
        lixeira, descarga, mictorio, encanamento, odorizante, lampada, porta, interruptor, sensor_de_luz, janela, macaneta, batente) {
            this.genero = genero;
